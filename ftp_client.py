...
class FTPClient:
	...
	def __init__(self, host):
		...
		if os.path.isdir('{0}{1}bin{1}'.format(os.getcwd(), os.sep)) == False:
	...
	# Allows main.py to receive relevant information about the program executions
	...
	def get_size(self, filename):
		# The command below is here to ensure binary mode is used in order to get size
